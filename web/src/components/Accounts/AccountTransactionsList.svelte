...
<section class="transactions-container">
    ...
    {#if !isAtm}
        <div class="export-data">
            <button class="btn btn-blue" style="display: flex; align-items: center; justify-content: center; gap: 1rem" on:click|preventDefault={handleClickExportData}><i class="fa-solid fa-file-export fa-fw" />
